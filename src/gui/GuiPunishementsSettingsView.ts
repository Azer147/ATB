...
export class GuiPunishementsSettingsView {
    ...
    public static buildPunishementsSettingsPage(parent: HTMLElement) {
        this.loadSettings();
    ...
    private static buildFullBondageCard(): HTMLElement {
        // Fields
        const FIELD_ENABLE: GuiFormField = {
            ...
            onChange: (value: boolean) => { this.settings.fullBondagePunishmentSettings.enable = value; }
        };
        const FIELD_WEIGHT: GuiFormField = {
            ...
            onChange: (value: number) => { this.settings.fullBondagePunishmentSettings.randomWeight = value; }
        };
        const FIELD_DURATION: GuiFormField = {
            ...
            onChange: (value: number) => { this.settings.fullBondagePunishmentSettings.baseDurationMs = value * 1000 * 60; }
        };
        const FIELD_REWARD: GuiFormField = {
            ...
            onChange: (value: number) => { this.settings.fullBondagePunishmentSettings.baseGoodPtsReward = value; }
        };
        const FIELD_PENALTY: GuiFormField = {
            ...
            onChange: (value: number) => { this.settings.fullBondagePunishmentSettings.baseBadPointsPenalty = value; }
        };
        const FIELD_PTS_REDUCTION: GuiFormField = {
            ...
            onChange: (value: number) => { this.settings.fullBondagePunishmentSettings.baseBadPtsReduction = value; }
        };
